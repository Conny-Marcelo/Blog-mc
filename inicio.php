...
<!-- </div> -->
 ...
 <footer class="container-fluid mt-3">
    <div class="row bg-dark text-light">
        <div class="col">
            <p class="text-center">Copyright María Concepción Correa Marcelo (c) 2020. Todos los derechos reservados.</p>
            <p class="text-center"><a href="mailto:">mary.correa.marcelo@gmail.com</a></p>
        </div>
    </div>
</footer>
